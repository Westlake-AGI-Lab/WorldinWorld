...
class CausalWanSelfAttention(nn.Module):
    ...
    def __init__(self,
        ...
        # World-in-World hook: an external object with attend(layer_id, q, k_cache, v_cache)
        # that injects extra key/value evidence into this layer's attention. None = original.
        self.kv_bank = None
        self.layer_id = -1
    ...
    def forward(
        ...
        if self.kv_bank is not None:
            x = self.kv_bank.attend(self.layer_id, roped_query, k_cache, v_cache)
        else:
